...
if redis:get(flash..'group:add'..msg.chat_id_) then  return '🎗*│*المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
if not redis:get(flash..'group:add'..msg.chat_id_) then return '🛠*│* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
.."\n⃣│التاك «» "..(redis:get(flash..'lock_tag'..msg.chat_id_) or 'false')
...
.."\n⚜️│الماركدوان «» "..(redis:get(flash..'lock_markdown'..msg.chat_id_) or 'false')
...
.."\n◽️│الانلاين «» "..(redis:get(flash..'mute_inline'..msg.chat_id_) or 'false')
